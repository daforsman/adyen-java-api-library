...
public class PaymentsResponse {
    ...
    public String toString() {
        ...
        sb.append("    resultCode: ").append(toIndentedString(serviceError)).append("\n");
        sb.append("    resultCode: ").append(toIndentedString(authResponse)).append("\n");
        sb.append("    resultCode: ").append(toIndentedString(merchantReference)).append("\n");
        sb.append("}");
        return sb.toString();
    }
